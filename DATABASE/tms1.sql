...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2021 at 06:37 AM
...
--
-- Table structure for table `guideassign`
--

CREATE TABLE `guideassign` (
...
CREATE TABLE `tblguide` (
  `Guided` int(11) NOT NULL,
  `GuideName` varchar(20) NOT NULL,
  `GuideEmail` varchar(35) NOT NULL,
  `GuideLocation` varchar(20) NOT NULL,
...
--
-- Indexes for table `guideassign`
--
ALTER TABLE `guideassign`
...
--
-- AUTO_INCREMENT for table `guideassign`
--
ALTER TABLE `guideassign`
...
--
ALTER TABLE `tblguide`
  MODIFY `Guided` int(11) NOT NULL AUTO_INCREMENT;
